...
enum TaskCardStatus {
  peding(Icons.access_time, 'Pendente'),
...
class TaskCard extends StatelessWidget {
  ...
  const TaskCard({super.key, required this.board, required this.height});
